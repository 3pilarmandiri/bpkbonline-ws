...
<div style="width:1000px; margin:10px; font-size:12px;">
			...
			<table width="100%" border="0"  class="listtabel">
              <tr>
				...
				echo form_dropdown("id_akun_pendapatan",$arr,'',
				'id="id_akun_pendapatan" class="form-control"');
				?></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
 ...
 function cetak(){
	 ...
	 v_id_akun_pendapatan = $("#id_akun_pendapatan").val();
 	window.open('<?php echo site_url("$controller/cetak"); ?>/'+$("#periode").val()+'/'+$("#bulan").val()+'/'+v_tanggal+'/'+v_id_akun_pendapatan );
 }
 </script>