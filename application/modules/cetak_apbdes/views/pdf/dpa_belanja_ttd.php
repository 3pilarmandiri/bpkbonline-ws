...
<table width="100%" border="1" cellpadding="3" class="cetak">
  <tr>
    <td width="49%"><h4><span class="tebal full-border">RENCANA PENARIKAN DANA PER TRIWULAN</span></h4></td>
  ...
  <tr>
    <td valign="top"><table  width="84%" border="0">
      <tr>
        ...
        //$tw=$this->dm->get_penarikan_triwulan("v_belanja",$id_kegiatan); 
        $tw['t1'] = $this->add->get_total_by_id("belanja","t1",$id_kegiatan,$this->id_desa,$this->tahun);
		$tw['t2'] = $this->add->get_total_by_id("belanja","t2",$id_kegiatan,$this->id_desa,$this->tahun);
		$tw['t3'] =$this->add->get_total_by_id("belanja","t3",$id_kegiatan,$this->id_desa,$this->tahun);
		$tw['t4'] =$this->add->get_total_by_id("belanja","t4",$id_kegiatan,$this->id_desa,$this->tahun);
		$tw['total'] = $tw['t1'] +   $tw['t2'] +  $tw['t3'] +  $tw['t4'] ; 
        ?>
        </tr>
      <tr>
