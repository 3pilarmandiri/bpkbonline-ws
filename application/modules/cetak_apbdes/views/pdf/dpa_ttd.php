...
<table width="100%" border="1" cellpadding="3" class="cetak">
  <tr>
    <td width="49%"><h4><span class="tebal full-border">RENCANA PENDAPATAN DANA PER TRIWULAN</span></h4></td>
  ...
  <tr>
    <td valign="top"><table  width="84%" border="0">
      <tr>
        ...
        <td>&nbsp;</td>
        <?php 
		/*$tw=$this->dm->get_penarikan_triwulan("v_pendapatan"); */
		$tw['t1'] = $this->add->get_total_by_id("pendapatan","t1","1",$this->id_desa,$this->tahun);
		$tw['t2'] = $this->add->get_total_by_id("pendapatan","t2","1",$this->id_desa,$this->tahun);
		$tw['t3'] =$this->add->get_total_by_id("pendapatan","t3","1",$this->id_desa,$this->tahun);
		$tw['t4'] =$this->add->get_total_by_id("pendapatan","t4","1",$this->id_desa,$this->tahun);
		$tw['total'] = $tw['t1'] +   $tw['t2'] +  $tw['t3'] +  $tw['t4'] ; //$this->add->subtotal_tw("1","v_pendapatan","total",$this->tahun,$this->id_desa) ;
		?>
        </tr>
      <tr>
        <td width="48%">Triwulan I</td>
        <td width="11%">Rp</td>
        <td width="41%" align="right"><?php echo rupiah($tw['t1']); ?></td>
        </tr>
      <tr>
        <td>Triwulan II</td>
        <td>Rp</td>
