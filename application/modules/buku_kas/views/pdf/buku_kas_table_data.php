...
<table width="100%" border="1" cellpadding="3">
  <tr>
    <td><table width="100%" border="0" cellpadding="7" cellspacing="0">
      <tr>
        <td width="19%" align="right" valign="top"><img width="50px" height="60px" src="<?php echo base_url(); ?>/assets/images/ksb-header.png" /></td>
        <td width="60%" align="center" valign="top"><b><font size="8px">PEMERINTAH <?php echo $data_desa->kota; ?> KECAMATAN <?php echo $data_desa->kecamatan ?> <br />
...
<table class="cetak" width="100%" border="0" cellpadding="3">
  ...
  ?>
   <tr>
     ...
     <td width="10%"   class="full-border"  scope="col"><?php echo ($row->jenis=="k")?$row->belanja_kode:$row->pendapatan_kode; ?></td>
     ...
     <td width="10%"  align="right" class="full-border"  scope="col"><?php echo $row->no_faktur; ?></td>
   ...
   <tr>
     <td colspan="4"  class="full-border"  scope="col"><strong>SALDO KAS TUNAI</strong></td>
     <td  align="right" class="full-border"  scope="col">&nbsp;</td>
     <td  align="right" class="full-border"  scope="col"><strong><?php echo rupiah($saldo); ?></strong></td>
     <td  align="right" class="full-border"  scope="col">&nbsp;</td>
     <td  align="right" class="full-border"  scope="col">&nbsp;</td>
     <td  align="right" class="full-border"  scope="col">&nbsp;</td>
   </tr>
